...
@Data
@JsonSerialize(using = CustomDoctorDtoSerializer.class)
public class DoctorDto {
    ...
    public DoctorDto(
        ...
        this.userPersonalJopInfo = new UserPersonalJopInfo(bloodGroup,
                specialty,subSpecialty, enabled,  accountNonExpired,  credentialsNonExpired,  accountNonLocked);
