package com.azu.hospital.ph.pharmacy_drugs.drugs_request_from_patient_to_pharmacy.drug_request_handler_deleted_item.entity;
...
@Getter
@Setter
@Table(name = "drug_request_handler_deleted_item")
public class DrugRequestHandlerDeletedItem {
    @Id
    @SequenceGenerator(
            name = "drug_request_handler_deleted_item_id_seq",
            sequenceName = "drug_request_handler_deleted_item_id_seq",
            allocationSize = 1
    )
    @GeneratedValue(
            strategy = GenerationType.SEQUENCE,
            generator = "drug_request_handler_deleted_item_id_seq"
    )
    ...
    private Boolean isDrugDeleted;

    private Boolean isDrugStopped;
    ...
    public DrugRequestHandlerDeletedItem() {
    }

    public DrugRequestHandlerDeletedItem(Long drugId, Integer quantity, String rejectCause, Instant createAt, Instant updateAt) {
        this.drugId = drugId;
    ...
    public DrugRequestHandlerDeletedItem(Integer quantity, UnitInventoryRequestEnum requestStatus, String timesDay,String timesServing, String does, String roa, MedicineType type, String note, String rejectCause, BaseUser signature, Instant createAt, Instant updateAt) {
        this.quantity = quantity;
